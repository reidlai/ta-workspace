        ...
        (function (s, p) {
          ...
          class U {
            ...
            parse() {
              ...
              if (this.lexer.current.type !== "EOF")
                throw new y(this.lexer.current);
              return t;
            }
            parseType(t) {
          ...
          const vt = h({
              ...
              parseInfix: (e, t) => {
                ...
                if (e.consume("infer")) {
                  i = !0;
                  const l = e.parseIntermediateType(d.SYMBOL);
          ...
          function Q({
            ...
            return function (i, l, f) {
              if (f == null || l >= d.NAME_PATH) return null;
              ...
              const Le = n !== null ? new U(n, i.lexer, i) : i,
                I = Le.parseIntermediateType(d.NAME_PATH);
          ...
          function ce({
            ...
            return h({
              ...
              parsePrefix: (i) => {
                ...
                const k = i.parseIntermediateType(d.FUNCTION);
              ...
              parsePrefix: (n) => {
                ...
                if (!n.consume("}")) {
                  ...
                  for (;;) {
                    ...
                    let f = l.parseIntermediateType(d.OBJECT);
                    (n.acceptLexerState(l),
                      f === void 0 &&
                        t &&
                        (f = n.parseIntermediateType(d.OBJECT)));
                    let g = !1;
                    if (
            ...
            return h({
              ...
              parseInfix: (i, l) => {
                ...
                if (
                  ...
                  const Z = x.parseType(d.KEY_VALUE);
                  return (
                  ...
                  if (!t) throw new m(l);
                  x.consume(":");
                  const S = x.parseType(d.KEY_VALUE);
                  return (
                    i.acceptLexerState(x),
            ...
            qt = h({
              ...
              parsePrefix: (e) => {
                ...
                do {
                  ...
                  let l;
                  e.consume("extends") &&
                    ((l = e.parseType(d.SYMBOL)),
                    l.type === "JsdocTypeOptional" &&
                      ((l = l.element), (a = e.parseType(d.SYMBOL))));
            ...
            Gt = h({
              ...
              parsePrefix: (e) => (
                e.consume("readonly"),
                {
                  ...
                  element: kt(e.parseIntermediateType(d.ALL)),
                }
              ),
            }),
            Xt = h({
          ...
          const tn = {
            ...
            JsdocTypeSymbol: (e) => {
              let t = "",
                ...
                a = !1;
              return (
                (n == null ? void 0 : n.type) === "JsdocTypeVariadic" &&
                  (n.meta.position === "prefix" ? (t = "...") : (a = !0),
                  (n = n.element)),
                (n == null ? void 0 : n.type) === "JsdocTypeName"
                  ? (t += n.value)
                  : (n == null ? void 0 : n.type) === "JsdocTypeNumber" &&
                    (t += n.value.toString()),
                a && (t += "..."),
                R(`${e.value}(${t})`)
              );
...
function qe({ fence: r = "```" } = {}) {
  let o = Be(r),
    s = c((p, u) => (o(p) ? !u : u), "toggleFence");
  return c(function (p) {
    let u = [[]],
      y = !1;
    for (let m of p)
      (hn.test(m.tokens.description) && !y
        ? u.push([m])
        : u[u.length - 1].push(m),
...
function Ce({ startLine: r = 0, markers: o = _ } = {}) {
  ...
  return c(function (u) {
    ...
    if (
      ((m.description = y), s.push({ number: p, source: u, tokens: m }), p++, T)
    ) {
      let J = s.slice();
      return ((s = null), J);
    }
...
function et({
  ...
  spacing: s = "compact",
  markers: p = _,
  tokenizers: u = [Ge(), Xe(s), Qe(), He(s)],
} = {}) {
  if (r < 0 || r % 1 > 0) throw new Error("Invalid startLine");
  let y = Ce({ startLine: r, markers: p }),
    m = qe({ fence: o }),
    T = Ye({ tokenizers: u }),
    J = he(s);
  return function (O) {
...
function kn(r, o) {
  if (r != null) {
    let { value: s } = r;
    if (!ee(s)) return pt(s) ? E(o == null ? void 0 : o.name, s) : E(s);
  }
  return null;
}
...
function An(r, o, s) {
  let { description: p, required: u, defaultValue: y } = s;
  return {
    name: r,
    type: Tt(o),
    required: u,
...
function vn(r, o) {
  var s;
  if (o != null && o.includesJsDoc) {
    let { description: p, extractedTags: u } = o;
    p != null && (r.description = o.description);
    let y = {
      ...u,
      params:
        (s = u == null ? void 0 : u.params) == null
          ? void 0
          : s.map((m) => ({
              name: m.getPrettyName(),
              description: m.description,
            })),
    };
    Object.values(y).filter(Boolean).length > 0 && (r.jsDocTags = y);
  }
  return r;
}
c(vn, "applyJsDocResult");
function Rn(r, o, s, p) {
  let u = bn(o.description);
