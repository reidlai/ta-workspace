import { v as T } from "./v4-CtRu48qb.js";
const { addons: m } = __STORYBOOK_MODULE_PREVIEW_API__,
  { ImplicitActionsDuringRendering: A } =
...
var b = "storybook/actions",
  ...
  f = (t, e) => {
    ...
    return !r || e(r) ? r : f(r, e);
  },
  x = (t) =>
    !!(
      typeof t == "object" &&
      t &&
      f(t, (e) => /^Synthetic(?:Base)?Event$/.test(e.constructor.name)) &&
  ...
  let r = { ...v, ...e },
    n = function (...o) {
      ...
      if (e.implicit) {
        ...
        if (g) {
          let c = !(
              (d = globalThis == null ? void 0 : globalThis.FEATURES) != null &&
              d.disallowImplicitActionsInRenderV8
            ),
            u = new A({ phase: g.phase, name: t, deprecated: c });
          if (c) console.warn(u);
          else throw u;
        }
      }
...
var R = (t, e) => typeof e[t] > "u" && !(t in e),
  j = (t) => {
    ...
    return Object.entries(r)
      .filter(([s]) => !!i.test(s))
      .reduce(
        (s, [a, _]) => (R(a, e) && (s[a] = p(a, { implicit: !0, id: n })), s),
        {},
      );
  },
  w = (t) => {
    ...
    return (n != null && n.disable) || !r
      ...
      : Object.entries(r)
          ...
          .reduce(
            (o, [i, s]) => (
              R(i, e) && (o[i] = p(typeof s.action == "string" ? s.action : i)),
              o
            ),
            {},
          );
  ...
  B = [C];
export { L as argsEnhancers, B as loaders };
