try {
  (() => {
    ...
    var ce = we((le, Z) => {
      ...
      (function (e) {
        ...
        return (function s(l, w, p) {
          ...
          for (var i = typeof x == "function" && x, m = 0; m < p.length; m++)
            o(p[m]);
          return o;
        })(
          {
    ...
    var $ = Se(ce()),
      ...
      _e = globalThis.FEATURES?.viewportStoryGlobals ? ke : Ce,
      pe = (e, t) => e.indexOf(t),
      Ee = (e, t) => {
        let a = pe(e, t);
        ...
        return c.createElement(
          ...
          c.createElement(
            ...
            c.createElement(
              ...
              t !== P
                ? c.createElement(xe, null, t.name, " ", l ? "(L)" : "(P)")
                : null,
            ),
          ),
          c.createElement(Y, {
      ...
      Ge = v.div({ display: "inline-flex", alignItems: "center" }),
      ue = v.div(({ theme: e }) => ({
        display: "inline-block",
        textDecoration: "none",
        padding: 10,
    ...
    H.register(B, (e) => {
      H.add(B, {
        ...
        render: () =>
          FEATURES?.viewportStoryGlobals ? N(Le, { api: e }) : N(Ue, null),
      });
    });
  })();
} catch (e) {
