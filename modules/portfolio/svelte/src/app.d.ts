declare module '$app/navigation' {
    export function goto(url: string | URL, opts?: { replaceState?: boolean; noScroll?: boolean; keepFocus?: boolean; state?: any; invalidateAll?: boolean }): Promise<void>;
...
declare module '$app/stores' {
    ...
    export function getStores(): { page: Readable<any>; navigating: Readable<any>; updated: Readable<boolean> };
}
