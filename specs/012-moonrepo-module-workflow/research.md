...
- **Alternatives Considered**:
  - _Bash_: Too brittle for complex JSON/YAML parsing and error handling constraints (RB-002).
  - _Go_: Robust, but adding a compiled binary build step for a workflow script adds friction compared to `ts-node` or `tsx`.
